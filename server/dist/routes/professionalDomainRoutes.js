...
const fileUpload_1 = __importStar(require("../middleware/fileUpload"));
...
// Bulk upload route
router.post('/bulk-upload', fileUpload_1.default.single('file'), fileUpload_1.cleanupFiles, professionalDomainController_1.default.bulkCreate);
