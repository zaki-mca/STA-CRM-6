    ...
    try {
      ...
      `);
        ...
        `, [result.rows[0].id]);
            ...
            const sampleResult = await (0, db_1.query)(`
      ...
      `);
            ...
            const providerInvoicesResult = await (0, db_1.query)(`
      ...
      `);
            ...
            providerInvoicesResult.rows.forEach((row, index) => {
...
//# sourceMappingURL=addSampleProvider.js.map