...
async function addColumnsToOrderLogs() {
    ...
    `;
        const actionColumnCheck = await (0, db_1.query)(checkActionColumnSQL);
    ...
    `;
        const closedAtColumnCheck = await (0, db_1.query)(checkClosedAtColumnSQL);
...
//# sourceMappingURL=addColumnsToOrderLogs.js.map