...
async function updateOrderLogSchema() {
    try {
        ...
        const checkEntriesTable = await (0, db_1.query)(`
      SELECT EXISTS (
    ...
    `);
      ...
      `);
        ...
        const checkOrderIdColumn = await (0, db_1.query)(`
      SELECT EXISTS (
    ...
    `);
      ...
      `);
            ...
            try {
                await (0, db_1.query)(`DROP INDEX IF EXISTS idx_order_logs_order;`);
                console.log('Dropped index on order_id');
            }
            catch (error) {
                console.log('No index found or could not drop index:', error.message);
            }
        ...
        `);
                ...
                console.log('Could not drop NOT NULL constraint:', error.message);
...
//# sourceMappingURL=updateOrderLogSchema.js.map