...
>(({ className, children, ...props }: any, ref) => {
  ...
  // Create a hidden description element for accessibility
  const accessibilityDescription = (
    <DialogPrimitive.Description id={dialogDescriptionId} className="sr-only">
      Dialog content
  ...
  return (
    <DialogPortal>
      ...
      >
        {/* Insert the accessibility description */}
